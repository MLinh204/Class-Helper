...
function pageTransition(t) {
  ...
  if (t.target) {
    // Store the current and previous page states
    previousPage = currentPage;
    currentPage = t.target;
    ...
    $("a").click(function (n) {
      ...
      if (t.conditions(n, a)) {
        ...
        setTimeout(function () {
          // Handle preloader behavior based on the previous page state
          if (previousPage) {
            if (previousPage === document.querySelector('.page')) {
              // The user is navigating back to the previous page
              plugins.preloader.addClass('loaded');
            } else {
              // The user is navigating to a different page
